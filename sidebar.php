                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="app-sidebar__heading" style="color:red;">MANAGE COURSE</li>
                                <li>
                                    <a href="#">
                                ...
                                <li class="app-sidebar__heading" style="color:red;">MANAGE EXAM</li>
                                <li>
                                    <a href="#">
                                         <i class="metismenu-icon pe-7s-display2"></i>
                                         Exam
                                ...
                                <li class="app-sidebar__heading" style="color:red;">MANAGE EXAMINEE</li>
                                ...
                                <li class="app-sidebar__heading" style="color:red;">RANKING</li>
                                <li>
                                ...
                                <li class="app-sidebar__heading" style="color:red;">REPORTS</li>
                                <li>
                                 ...
                                 <li class="app-sidebar__heading" style="color:red;">FEEDBACKS</li>
                                <li>
